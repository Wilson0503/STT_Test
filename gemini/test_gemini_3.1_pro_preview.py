...
MODEL_NAME = "gemini-3.1-pro-preview"  # 3.1 Pro Preview 版本
SUPPORTED_MEDIA_EXTENSIONS = {".wav", ".mp3", ".m4a", ".mp4"}
# ==========================================

def test_gemini_3_1_pro_preview_audio():
    if not API_KEY:
        print("❌ 錯誤: 找不到 API_KEY")
        return
    client = genai.Client(api_key=API_KEY)
    print(f"🚀 啟動 Gemini 3.1 Pro Preview 純逐字稿測試: {MODEL_NAME}")
...
if __name__ == "__main__":
    test_gemini_3_1_pro_preview_audio()
